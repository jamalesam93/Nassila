...
|----------|-------|--------|
| **P0** | App **1.2.1 Masdar UX** — loop in-progress panel (#4b), DOI conflict manual-only (#4c), attach PDF, shortcuts, icon I2 | **Next** |
...
**Models on Hub:** Sanad **S12** (E4B default) · **S14** (12B quality). No change with app 1.2.0.
...
- **DOI↔title conflicts:** auto-resolution bugs documented → **1.2.1 #4c** (manual-only).
...
1. **1.2.1 Masdar UX** — #4b in-progress panel, #4c DOI conflict manual-only, #5–6, #8, icon I2.

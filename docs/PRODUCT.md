...
**Settings** holds LM Studio slots: `nassila-sanad-4b` (default, **S15**), optional `nassila-sanad-12b` (**S14** quality tier). Run laptop smoke ([`LAPTOP_SMOKE_TEST.md`](https://github.com/jamalesam93/NassilaT/blob/main/training/LAPTOP_SMOKE_TEST.md)) on downloaded GGUFs before treating release as verified.

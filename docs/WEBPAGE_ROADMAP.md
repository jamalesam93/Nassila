...
Train after **Sanad Tier 2** on 12B (`nassila-sanad-12b` **v1.12+**) or as facets merged into **`nassila-agent-*`**. Ship checkpoints: E4B/12B **v1.12** — see NassilaT [`POST_V113_MAP.md`](https://github.com/jamalesam93/NassilaT/blob/main/training/POST_V113_MAP.md).

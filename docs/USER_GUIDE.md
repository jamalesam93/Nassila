...
3. Select the Sanad model: **9B** (sole tier; Q4_K_M ~5.2 GB / Q6_K ~6.9 GB, 8–10 GB+ VRAM).
4. The model auto-defaults to `nassila-sanad-9b`.
...
- **Model chip** — Sanad 9B (sole supported tier)

...
3. Select a tier chip: **4B** (default, ~3.3 GB VRAM) or **12B** (quality, ~9.1 GB+ VRAM).
4. The model auto-defaults to `nassila-sanad-4b` / `nassila-sanad-12b`.
...
- **Tier chip** — switch between 4B and 12B

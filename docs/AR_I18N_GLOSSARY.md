...
Keep in Latin script in UI: **DOI**, **PMID**, **ISBN**, **Crossref**, **PubMed**, **OpenAlex**, **CSL**, **CSL-JSON**, **BibTeX**, **RIS**, **L1**, **L2**, **L3**, **GGUF**, **LM Studio**, **Ollama**, **vLLM**, **Hugging Face**, **Unpaywall**, **Europe PMC**, **JSON**, **PDF**, **DOCX**, **API**, **IPC**, model ids (`nassila-sanad-9b`, etc.).

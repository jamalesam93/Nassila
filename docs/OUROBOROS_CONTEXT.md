...
> **For agents.** Single entry point for Nassila + NassilaT. Last updated: 2026-09-06.
> **App:** **2.0.0** shipped (2026-09-06) · MaktabOCR + Shahid LIVE. **Next cut:** **2.1.0 Sanad Arabic** (FT-7).
> **Ship checkpoints:** `nassila-sanad-9b` **FT-6** (Qwen 3.5 9B, sole Sanad tier on Hub; v119) · `nassila-sanad-4b` **S15** and `nassila-sanad-12b` **S14** retired (abstract-era). **v1.13 NO-GO.** **Tier 3 + multimodal 2.0.0 gates PASS** (2026-09-06). Operator map: NassilaT [`training/OUROBOROS_OPERATOR_MAP.md`](https://github.com/jamalesam93/NassilaT/blob/main/training/OUROBOROS_OPERATOR_MAP.md). Sign-off: [`training/EVAL_GONOGO_TIER3_MEMO.md`](https://github.com/jamalesam93/NassilaT/blob/main/training/EVAL_GONOGO_TIER3_MEMO.md).
...
| 2 | **Maktab** | مكتب | `doc_extract` | Bring in the manuscript | File I/O, DOCX/PDF routing, native pdf-inspector + selective OCR fallback | Structured text/chunks from PDF/DOCX | 2 | **LIVE in 2.0.0** (native + Arabic adapter) |
...
| 4 | **Shahid** | شاهد | `table_figure_grounding` | Tables & figures as evidence | Region detection (pdf-inspector / anydoc) | Claims vs table/figure regions | 3+ | **LIVE in 2.0.0** (table/figure evidence extraction) |
...
| **2** | **Abstract Sanad ship** | Pass **model gates** in §10 on abstract-only harness | **Met** (FT-6 v119 on Hub) |
...
| **3** | **Product Sanad ship** | Tier 2 model gates + **Masdar** body-text pipeline + full-text eval slice | **PASS** (shipped in 2.0.0 with MaktabOCR + Shahid LIVE) |
...
**HF Sanad GGUF:** [`QinEmPeRoR93/nassila-sanad-9b`](https://huggingface.co/QinEmPeRoR93/nassila-sanad-9b) (9B, 6 default + 6 MTP quants, **checkpoint FT-6** — sole tier) · [`QinEmPeRoR93/nassila-sanad-9b-unquant`](https://huggingface.co/QinEmPeRoR93/nassila-sanad-9b-unquant) (bf16) · [`QinEmPeRoR93/nassila-sanad-9b-v119-lora`](https://huggingface.co/QinEmPeRoR93/nassila-sanad-9b-v119-lora) (FT-6 LoRA) · [`QinEmPeRoR93/nassila-sanad-9b-lora`](https://huggingface.co/QinEmPeRoR93/nassila-sanad-9b-lora) (FT-5 LoRA, legacy) · [`QinEmPeRoR93/nassila-sanad-4b`](https://huggingface.co/QinEmPeRoR93/nassila-sanad-4b) (4B Q6_K, **S15**, retired) · [`QinEmPeRoR93/nassila-sanad-12b`](https://huggingface.co/QinEmPeRoR93/nassila-sanad-12b) (12B Q6_K, **S14**, retired) · E4B S12 legacy. Upload: [`PHASE2_9_AB_PILOT_WALKTHROUGH.md`](https://github.com/jamalesam93/NassilaT/blob/main/training/PHASE2_9_AB_PILOT_WALKTHROUGH.md) Part 9 · Verify: [`HF_RELEASE_VERIFY.md`](https://github.com/jamalesam93/NassilaT/blob/main/training/HF_RELEASE_VERIFY.md)
...
- **Default tier (now):** Qwen 3.5 **9B** — **`nassila-sanad-9b` FT-6** (Qwen3.5-9B QLoRA on v119; 6 default + 6 MTP GGUFs). 4B S15 retired as default (app registry switch per `FEATURES-AND-TWEAKS.md` #17).
...
- **Shahid:** bounded table/figure evidence **LIVE in 2.0.0** after multimodal gate PASS (not 12B-required)

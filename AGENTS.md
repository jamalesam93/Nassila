...
- **Ouroboros** ([`docs/OUROBOROS.md`](docs/OUROBOROS.md), agent brief [`docs/OUROBOROS_CONTEXT.md`](docs/OUROBOROS_CONTEXT.md)): seven workers as future product modules. **Sanad** default `nassila-sanad-e4b`; optional `nassila-sanad-12b` (Tier 2 PASS at checkpoint v1.10). Task ids: [`src/shared/nassila-agent-tasks.ts`](src/shared/nassila-agent-tasks.ts). UI reform: [`docs/PRODUCT.md`](docs/PRODUCT.md), [`docs/DESIGN.md`](docs/DESIGN.md). **Training:** [`docs/TRAINING.md`](docs/TRAINING.md) → NassilaT.

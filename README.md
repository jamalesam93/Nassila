...
> End users: install from **Releases** ([**v1.4.0**](https://github.com/jamalesam93/Nassila/releases/tag/v1.4.0)) or visit the [**website**](https://nassila-web.vercel.app). Developers: clone this repo and see [Getting started](#getting-started).
...
- **Raqim Statute** — Resolve legislation via US federal, UK `legislation.gov.uk`, and `.gov` official catalogues (EU ELI retained).
- **Legal bibliography import** — statute numbers split across PDF/DOCX lines merge correctly.
- **Sharh-lite** — citation-mapping coverage in preflight; export a submission integrity bundle (no manuscript body).
- **Masdar** — page-aware source excerpts during grounding.

Full notes: [CHANGELOG.md](CHANGELOG.md) · [v1.4.0 release](https://github.com/jamalesam93/Nassila/releases/tag/v1.4.0).
